...
@documentation("Public endpoint allowing users to submit Sudoku puzzles as images and receive a solution if solvable. Supports requests sent as either multipart/form-data or application/json. When using application/json, the image must be provided as a base64-encoded string.")
