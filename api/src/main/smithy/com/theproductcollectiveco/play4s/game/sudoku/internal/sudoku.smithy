...
@documentation("Internal endpoint allowing users to request hints for a Sudoku puzzle. Users can specify a search strategy and the number of hints they want.")
